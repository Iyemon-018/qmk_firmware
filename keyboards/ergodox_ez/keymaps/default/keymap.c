 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * | `      |   1  |   2  |   3  |   4  |   5  | PrtSC|           |E to J|   6  |   7  |   8  |   9  |   0  |   -    |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |  Tab   |   Q  |   W  |   E  |   R  |   T  |  L1  |           |  Esc |   Y  |   U  |   I  |   O  |   P  | BackSP |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |  None  |   A  |   S  |   D  |   F  |   G  |------|           |------|   H  |   J  |   K  |   L  |  ; + |  Enter |
 * |--------+------+------+------+------+------|Ctrl +|           |  B   |------+------+------+------+------+--------|
 * | LShift |Z/Ctrl|   X  |   C  |   V  |   B  |  F3  |           |      |   N  |   M  |   ,  |   .  | / ?  | RShift |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | Ctrl | Win  | LAlt | F5   | @    |                                       |  ^ ~ | : *  | [ {  |  ] } | \ _  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.        ,-------------.
 *                                        |PageUP|PageDW|       | Left | Right  |
 *                                 ,------|------|------|       |------+--------+------.
 *                                 |      |      | Home |       |  Up  |        |      |
 *                                 | Space|  F2  |------|       |------|  Del   |RShift|
 *                                 |      |      | End  |       | Down |        |      |
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_LSFT,        KC_Z,         KC_X,   KC_C,   KC_V,   KC_B,   LCTL(KC_F3),
        KC_LCTL,        KC_LGUI,      KC_LALT,KC_F5,  KC_LBRC,
                                               KC_PGUP, KC_PGDN,
                                                              KC_HOME,
                                               KC_SPC,KC_F2,    KC_END,
        // right hand
          LALT(KC_LSFT),KC_6,   KC_7,   KC_8,   KC_9,   KC_0,             KC_MINS,
...
[SYMB] = LAYOUT_ergodox(
       ...
       KC_TRNS, KC_AMPR, KC_TRNS,KC_UP,   KC_TRNS, KC_JYEN, KC_RSFT,
